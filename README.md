...
![](https://badgen.net/badge/changelog/v2.1.0/)
...
| [#208](https://github.com/dropbox/zxcvbn/issues/208) | Computed guesses for user-input matches is oddly high                                                         | The DP factorial multiplier inflates the combined guess count when all tokens come from user_inputs. **Known DP Limitation**.                                                                                                 | ❌ Not Fixed                                                |
...
| [#206](https://github.com/dropbox/zxcvbn/issues/206) | 'Administrator' password with special chars are indicated as a strong password                                | `aDm1n` is correctly detected as l33t `admin`, but `!str@t0r` cannot be reverse-mapped to `administrator` because `!` has no l33t mapping. **Algorithmic Limitation**.                                                        | ❌ Not Fixed                                                |
